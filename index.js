var Sr=Object.defineProperty;var Vt=e=>{throw TypeError(e)};var wr=(e,t,n)=>t in e?Sr(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n;var w=(e,t,n)=>wr(e,typeof t!="symbol"?t+"":t,n),bt=(e,t,n)=>t.has(e)||Vt("Cannot "+n);var u=(e,t,n)=>(bt(e,t,"read from private field"),n?n.call(e):t.get(e)),E=(e,t,n)=>t.has(e)?Vt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,n),g=(e,t,n,r)=>(bt(e,t,"write to private field"),r?r.call(e,n):t.set(e,n),n),k=(e,t,n)=>(bt(e,t,"access private method"),n);var Jt=(e,t,n,r)=>({set _(s){g(e,t,s,n)},get _(){return u(e,t,r)}});import{AsyncLocalStorage as Ar}from"node:async_hooks";function Cr(){const{process:e,Deno:t}=globalThis;return!(typeof(t==null?void 0:t.noColor)=="boolean"?t.noColor:e!==void 0?"NO_COLOR"in(e==null?void 0:e.env):!1)}var Pt="__COMPOSED_HANDLER",xn=e=>e.length>1,kn=e=>e[Pt]?kn(e[Pt]):e,Er=e=>e.name||(xn(e)?"[middleware]":"[handler]"),xr=e=>e.routes.map(({path:t,method:n,handler:r})=>{const s=kn(r);return{path:t,method:n,name:Er(s),isMiddleware:xn(s)}}),kr=(e,t)=>{const n=Cr(),r={};let s=0,o=0;xr(e).filter(({isMiddleware:a})=>!a).map(a=>{const i=`${a.method}-${a.path}`;if((r[i]||(r[i]=[])).push(a),!(r[i].length>1))return s=Math.max(s,a.method.length),o=Math.max(o,a.path.length),{method:a.method,path:a.path,routes:r[i]}}).forEach(a=>{if(!a)return;const{method:i,path:l,routes:c}=a,f=n?`\x1B[32m${i}\x1B[0m`:i;console.log(`${f} ${" ".repeat(s-i.length)} ${l}`)})};const Rr=e=>(e.status(404),e.render("404 Not Found")),Or=Object.freeze(Object.defineProperty({__proto__:null,default:Rr},Symbol.toStringTag,{value:"Module"})),jr=(e,t)=>"getResponse"in e?e.getResponse():(console.error(e.message),t.status(500),t.render("Internal Server Error")),Pr=Object.freeze(Object.defineProperty({__proto__:null,default:jr},Symbol.toStringTag,{value:"Module"}));var Rn={Stringify:1},B=(e,t)=>{const n=new String(e);return n.isEscaped=!0,n.callbacks=t,n},Ir=/[&<>'"]/,On=async(e,t)=>{let n="";t||(t=[]);const r=await Promise.all(e);for(let s=r.length-1;n+=r[s],s--,!(s<0);s--){let o=r[s];typeof o=="object"&&t.push(...o.callbacks||[]);const a=o.isEscaped;if(o=await(typeof o=="object"?o.toString():o),typeof o=="object"&&t.push(...o.callbacks||[]),o.isEscaped??a)n+=o;else{const i=[n];ue(o,i),n=i[0]}}return B(n,t)},ue=(e,t)=>{const n=e.search(Ir);if(n===-1){t[0]+=e;return}let r,s,o=0;for(s=n;s<e.length;s++){switch(e.charCodeAt(s)){case 34:r="&quot;";break;case 39:r="&#39;";break;case 38:r="&amp;";break;case 60:r="&lt;";break;case 62:r="&gt;";break;default:continue}t[0]+=e.substring(o,s)+r,o=s+1}t[0]+=e.substring(o,s)},jn=e=>{const t=e.callbacks;if(!(t!=null&&t.length))return e;const n=[e],r={};return t.forEach(s=>s({phase:Rn.Stringify,buffer:n,context:r})),n[0]},Pn=async(e,t,n,r,s)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(s?s[0]+=e:s=[e],Promise.all(o.map(i=>i({phase:t,buffer:s,context:r}))).then(i=>Promise.all(i.filter(Boolean).map(l=>Pn(l,t,!1,r,s))).then(()=>s[0]))):Promise.resolve(e)},_r=(e,...t)=>{const n=[""];for(let r=0,s=e.length-1;r<s;r++){n[0]+=e[r];const o=Array.isArray(t[r])?t[r].flat(1/0):[t[r]];for(let a=0,i=o.length;a<i;a++){const l=o[a];if(typeof l=="string")ue(l,n);else if(typeof l=="number")n[0]+=l;else{if(typeof l=="boolean"||l===null||l===void 0)continue;if(typeof l=="object"&&l.isEscaped)if(l.callbacks)n.unshift("",l);else{const c=l.toString();c instanceof Promise?n.unshift("",c):n[0]+=c}else l instanceof Promise?n.unshift("",l):ue(l.toString(),n)}}}return n[0]+=e.at(-1),n.length===1?"callbacks"in n?B(jn(B(n[0],n.callbacks))):B(n[0]):On(n,n.callbacks)},Bt=Symbol("RENDERER"),It=Symbol("ERROR_HANDLER"),O=Symbol("STASH"),In=Symbol("INTERNAL"),Tr=Symbol("MEMO"),ft=Symbol("PERMALINK"),Zt=e=>(e[In]=!0,e),_n=e=>({value:t,children:n})=>{if(!n)return;const r={children:[{tag:Zt(()=>{e.push(t)}),props:{}}]};Array.isArray(n)?r.children.push(...n.flat()):r.children.push(n),r.children.push({tag:Zt(()=>{e.pop()}),props:{}});const s={tag:"",props:r,type:""};return s[It]=o=>{throw e.pop(),o},s},Tn=e=>{const t=[e],n=_n(t);return n.values=t,n.Provider=n,Ie.push(n),n},Ie=[],Ht=e=>{const t=[e],n=r=>{t.push(r.value);let s;try{s=r.children?(Array.isArray(r.children)?new Nn("",{},r.children):r.children).toString():""}finally{t.pop()}return s instanceof Promise?s.then(o=>B(o,o.callbacks)):B(s)};return n.values=t,n.Provider=n,n[Bt]=_n(t),Ie.push(n),n},Ae=e=>e.values.at(-1),nt={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},_t={},rt="data-precedence",Ze=e=>Array.isArray(e)?e:[e],Xt=new WeakMap,Qt=(e,t,n,r)=>({buffer:s,context:o})=>{if(!s)return;const a=Xt.get(o)||{};Xt.set(o,a);const i=a[e]||(a[e]=[]);let l=!1;const c=nt[e];if(c.length>0){e:for(const[,f]of i)for(const h of c)if(((f==null?void 0:f[h])??null)===(n==null?void 0:n[h])){l=!0;break e}}if(l?s[0]=s[0].replaceAll(t,""):c.length>0?i.push([t,n,r]):i.unshift([t,n,r]),s[0].indexOf("</head>")!==-1){let f;if(r===void 0)f=i.map(([h])=>h);else{const h=[];f=i.map(([d,,m])=>{let b=h.indexOf(m);return b===-1&&(h.push(m),b=h.length-1),[d,b]}).sort((d,m)=>d[1]-m[1]).map(([d])=>d)}f.forEach(h=>{s[0]=s[0].replaceAll(h,"")}),s[0]=s[0].replace(/(?=<\/head>)/,f.join(""))}},Xe=(e,t,n)=>B(new K(e,n,Ze(t??[])).toString()),Qe=(e,t,n,r)=>{if("itemProp"in n)return Xe(e,t,n);let{precedence:s,blocking:o,...a}=n;s=r?s??"":void 0,r&&(a[rt]=s);const i=new K(e,a,Ze(t||[])).toString();return i instanceof Promise?i.then(l=>B(i,[...l.callbacks||[],Qt(e,l,a,s)])):B(i,[Qt(e,i,a,s)])},$r=({children:e,...t})=>{const n=Gt();if(n){const r=Ae(n);if(r==="svg"||r==="head")return new K("title",t,Ze(e??[]))}return Qe("title",e,t,!1)},Dr=({children:e,...t})=>{const n=Gt();return["src","async"].some(r=>!t[r])||n&&Ae(n)==="head"?Xe("script",e,t):Qe("script",e,t,!1)},Lr=({children:e,...t})=>["href","precedence"].every(n=>n in t)?(t["data-href"]=t.href,delete t.href,Qe("style",e,t,!0)):Xe("style",e,t),Nr=({children:e,...t})=>["onLoad","onError"].some(n=>n in t)||t.rel==="stylesheet"&&(!("precedence"in t)||"disabled"in t)?Xe("link",e,t):Qe("link",e,t,"precedence"in t),Mr=({children:e,...t})=>{const n=Gt();return n&&Ae(n)==="head"?Xe("meta",e,t):Qe("meta",e,t,!1)},$n=(e,{children:t,...n})=>new K(e,n,Ze(t??[])),Wr=e=>(typeof e.action=="function"&&(e.action=ft in e.action?e.action[ft]:void 0),$n("form",e)),Dn=(e,t)=>(typeof t.formAction=="function"&&(t.formAction=ft in t.formAction?t.formAction[ft]:void 0),$n(e,t)),Fr=e=>Dn("input",e),Br=e=>Dn("button",e);const yt=Object.freeze(Object.defineProperty({__proto__:null,button:Br,form:Wr,input:Fr,link:Nr,meta:Mr,script:Dr,style:Lr,title:$r},Symbol.toStringTag,{value:"Module"}));var Hr=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),ht=e=>Hr.get(e)||e,Ln=(e,t)=>{for(const[n,r]of Object.entries(e)){const s=n[0]==="-"||!/[A-Z]/.test(n)?n:n.replace(/[A-Z]/g,o=>`-${o.toLowerCase()}`);t(s,r==null?null:typeof r=="number"?s.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${r}`:`${r}px`:r)}},He=void 0,Gt=()=>He,Gr=e=>/[A-Z]/.test(e)&&e.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?e.replace(/([A-Z])/g,"-$1").toLowerCase():e,zr=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],Ur=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],zt=(e,t)=>{for(let n=0,r=e.length;n<r;n++){const s=e[n];if(typeof s=="string")ue(s,t);else{if(typeof s=="boolean"||s===null||s===void 0)continue;s instanceof K?s.toStringToBuffer(t):typeof s=="number"||s.isEscaped?t[0]+=s:s instanceof Promise?t.unshift("",s):zt(s,t)}}},K=class{constructor(e,t,n){w(this,"tag");w(this,"props");w(this,"key");w(this,"children");w(this,"isEscaped",!0);w(this,"localContexts");this.tag=e,this.props=t,this.children=n}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var t,n;const e=[""];(t=this.localContexts)==null||t.forEach(([r,s])=>{r.values.push(s)});try{this.toStringToBuffer(e)}finally{(n=this.localContexts)==null||n.forEach(([r])=>{r.values.pop()})}return e.length===1?"callbacks"in e?jn(B(e[0],e.callbacks)).toString():e[0]:On(e,e.callbacks)}toStringToBuffer(e){const t=this.tag,n=this.props;let{children:r}=this;e[0]+=`<${t}`;const s=He&&Ae(He)==="svg"?o=>Gr(ht(o)):o=>ht(o);for(let[o,a]of Object.entries(n))if(o=s(o),o!=="children"){if(o==="style"&&typeof a=="object"){let i="";Ln(a,(l,c)=>{c!=null&&(i+=`${i?";":""}${l}:${c}`)}),e[0]+=' style="',ue(i,e),e[0]+='"'}else if(typeof a=="string")e[0]+=` ${o}="`,ue(a,e),e[0]+='"';else if(a!=null)if(typeof a=="number"||a.isEscaped)e[0]+=` ${o}="${a}"`;else if(typeof a=="boolean"&&Ur.includes(o))a&&(e[0]+=` ${o}=""`);else if(o==="dangerouslySetInnerHTML"){if(r.length>0)throw"Can only set one of `children` or `props.dangerouslySetInnerHTML`.";r=[B(a.__html)]}else if(a instanceof Promise)e[0]+=` ${o}="`,e.unshift('"',a);else if(typeof a=="function"){if(!o.startsWith("on"))throw`Invalid prop '${o}' of type 'function' supplied to '${t}'.`}else e[0]+=` ${o}="`,ue(a.toString(),e),e[0]+='"'}if(zr.includes(t)&&r.length===0){e[0]+="/>";return}e[0]+=">",zt(r,e),e[0]+=`</${t}>`}},St=class extends K{toStringToBuffer(e){const{children:t}=this,n=this.tag.call(null,{...this.props,children:t.length<=1?t[0]:t});if(!(typeof n=="boolean"||n==null))if(n instanceof Promise)if(Ie.length===0)e.unshift("",n);else{const r=Ie.map(s=>[s,s.values.at(-1)]);e.unshift("",n.then(s=>(s instanceof K&&(s.localContexts=r),s)))}else n instanceof K?n.toStringToBuffer(e):typeof n=="number"||n.isEscaped?(e[0]+=n,n.callbacks&&(e.callbacks||(e.callbacks=[]),e.callbacks.push(...n.callbacks))):ue(n,e)}},Nn=class extends K{toStringToBuffer(e){zt(this.children,e)}},Tt=(e,t,...n)=>{t??(t={}),n.length&&(t.children=n.length===1?n[0]:n);const r=t.key;delete t.key;const s=st(e,t,n);return s.key=r,s},Yt=!1,st=(e,t,n)=>{if(!Yt){for(const r in _t)yt[r][Bt]=_t[r];Yt=!0}return typeof e=="function"?new St(e,t,n):yt[e]?new St(yt[e],t,n):e==="svg"||e==="head"?(He||(He=Ht("")),new K(e,t,[new St(He,{value:e},n)])):new K(e,t,n)},gt=({children:e})=>new Nn("",{children:e},Array.isArray(e)?e:e?[e]:[]),Kr=e=>!!(e&&typeof e=="object"&&"tag"in e&&"props"in e);function v(e,t,n){let r;if(!t||!("children"in t))r=st(e,t,[]);else{const s=t.children;r=Array.isArray(s)?st(e,t,s):st(e,t,[s])}return r.key=n,r}var Ge="_hp",qr={Change:"Input",DoubleClick:"DblClick"},Vr={svg:"2000/svg",math:"1998/Math/MathML"},_e=[],$t=new WeakMap,Te=void 0,Jr=()=>Te,Z=e=>"t"in e,wt={onClick:["click",!1]},en=e=>{if(!e.startsWith("on"))return;if(wt[e])return wt[e];const t=e.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(t){const[,n,r]=t;return wt[e]=[(qr[n]||n).toLowerCase(),!!r]}},tn=(e,t)=>Te&&e instanceof SVGElement&&/[A-Z]/.test(t)&&(t in e.style||t.match(/^(?:o|pai|str|u|ve)/))?t.replace(/([A-Z])/g,"-$1").toLowerCase():t,Zr=(e,t,n)=>{var r;t||(t={});for(let s in t){const o=t[s];if(s!=="children"&&(!n||n[s]!==o)){s=ht(s);const a=en(s);if(a){if((n==null?void 0:n[s])!==o&&(n&&e.removeEventListener(a[0],n[s],a[1]),o!=null)){if(typeof o!="function")throw new Error(`Event handler for "${s}" is not a function`);e.addEventListener(a[0],o,a[1])}}else if(s==="dangerouslySetInnerHTML"&&o)e.innerHTML=o.__html;else if(s==="ref"){let i;typeof o=="function"?i=o(e)||(()=>o(null)):o&&"current"in o&&(o.current=e,i=()=>o.current=null),$t.set(e,i)}else if(s==="style"){const i=e.style;typeof o=="string"?i.cssText=o:(i.cssText="",o!=null&&Ln(o,i.setProperty.bind(i)))}else{if(s==="value"){const l=e.nodeName;if(l==="INPUT"||l==="TEXTAREA"||l==="SELECT"){if(e.value=o==null||o===!1?null:o,l==="TEXTAREA"){e.textContent=o;continue}else if(l==="SELECT"){e.selectedIndex===-1&&(e.selectedIndex=0);continue}}}else(s==="checked"&&e.nodeName==="INPUT"||s==="selected"&&e.nodeName==="OPTION")&&(e[s]=o);const i=tn(e,s);o==null||o===!1?e.removeAttribute(i):o===!0?e.setAttribute(i,""):typeof o=="string"||typeof o=="number"?e.setAttribute(i,o):e.setAttribute(i,o.toString())}}}if(n)for(let s in n){const o=n[s];if(s!=="children"&&!(s in t)){s=ht(s);const a=en(s);a?e.removeEventListener(a[0],o,a[1]):s==="ref"?(r=$t.get(e))==null||r():e.removeAttribute(tn(e,s))}}},Xr=(e,t)=>{t[O][0]=0,_e.push([e,t]);const n=t.tag[Bt]||t.tag,r=n.defaultProps?{...n.defaultProps,...t.props}:t.props;try{return[n.call(null,r)]}finally{_e.pop()}},Mn=(e,t,n,r,s)=>{var o,a;(o=e.vR)!=null&&o.length&&(r.push(...e.vR),delete e.vR),typeof e.tag=="function"&&((a=e[O][1][We])==null||a.forEach(i=>s.push(i))),e.vC.forEach(i=>{var l;if(Z(i))n.push(i);else if(typeof i.tag=="function"||i.tag===""){i.c=t;const c=n.length;if(Mn(i,t,n,r,s),i.s){for(let f=c;f<n.length;f++)n[f].s=!0;i.s=!1}}else n.push(i),(l=i.vR)!=null&&l.length&&(r.push(...i.vR),delete i.vR)})},Qr=e=>{for(;;e=e.tag===Ge||!e.vC||!e.pP?e.nN:e.vC[0]){if(!e)return null;if(e.tag!==Ge&&e.e)return e.e}},Wn=e=>{var t,n,r,s,o,a;Z(e)||((n=(t=e[O])==null?void 0:t[1][We])==null||n.forEach(i=>{var l;return(l=i[2])==null?void 0:l.call(i)}),(r=$t.get(e.e))==null||r(),e.p===2&&((s=e.vC)==null||s.forEach(i=>i.p=2)),(o=e.vC)==null||o.forEach(Wn)),e.p||((a=e.e)==null||a.remove(),delete e.e),typeof e.tag=="function"&&(Ne.delete(e),ot.delete(e),delete e[O][3],e.a=!0)},Fn=(e,t,n)=>{e.c=t,Bn(e,t,n)},nn=(e,t)=>{if(t){for(let n=0,r=e.length;n<r;n++)if(e[n]===t)return n}},rn=Symbol(),Bn=(e,t,n)=>{var c;const r=[],s=[],o=[];Mn(e,t,r,s,o),s.forEach(Wn);const a=n?void 0:t.childNodes;let i,l=null;if(n)i=-1;else if(!a.length)i=0;else{const f=nn(a,Qr(e.nN));f!==void 0?(l=a[f],i=f):i=nn(a,(c=r.find(h=>h.tag!==Ge&&h.e))==null?void 0:c.e)??-1,i===-1&&(n=!0)}for(let f=0,h=r.length;f<h;f++,i++){const d=r[f];let m;if(d.s&&d.e)m=d.e,d.s=!1;else{const b=n||!d.e;Z(d)?(d.e&&d.d&&(d.e.textContent=d.t),d.d=!1,m=d.e||(d.e=document.createTextNode(d.t))):(m=d.e||(d.e=d.n?document.createElementNS(d.n,d.tag):document.createElement(d.tag)),Zr(m,d.props,d.pP),Bn(d,m,b))}d.tag===Ge?i--:n?m.parentNode||t.appendChild(m):a[i]!==m&&a[i-1]!==m&&(a[i+1]===m?t.appendChild(a[i]):t.insertBefore(m,l||a[i]||null))}if(e.pP&&delete e.pP,o.length){const f=[],h=[];o.forEach(([,d,,m,b])=>{d&&f.push(d),m&&h.push(m),b==null||b()}),f.forEach(d=>d()),h.length&&requestAnimationFrame(()=>{h.forEach(d=>d())})}},Yr=(e,t)=>!!(e&&e.length===t.length&&e.every((n,r)=>n[1]===t[r][1])),ot=new WeakMap,Dt=(e,t,n)=>{var o,a,i,l,c,f;const r=!n&&t.pC;n&&(t.pC||(t.pC=t.vC));let s;try{n||(n=typeof t.tag=="function"?Xr(e,t):Ze(t.props.children)),((o=n[0])==null?void 0:o.tag)===""&&n[0][It]&&(s=n[0][It],e[5].push([e,s,t]));const h=r?[...t.pC]:t.vC?[...t.vC]:void 0,d=[];let m;for(let b=0;b<n.length;b++){Array.isArray(n[b])&&n.splice(b,1,...n[b].flat());let p=es(n[b]);if(p){typeof p.tag=="function"&&!p.tag[In]&&(Ie.length>0&&(p[O][2]=Ie.map(S=>[S,S.values.at(-1)])),(a=e[5])!=null&&a.length&&(p[O][3]=e[5].at(-1)));let y;if(h&&h.length){const S=h.findIndex(Z(p)?A=>Z(A):p.key!==void 0?A=>A.key===p.key&&A.tag===p.tag:A=>A.tag===p.tag);S!==-1&&(y=h[S],h.splice(S,1))}if(y)if(Z(p))y.t!==p.t&&(y.t=p.t,y.d=!0),p=y;else{const S=y.pP=y.props;if(y.props=p.props,y.f||(y.f=p.f||t.f),typeof p.tag=="function"){const A=y[O][2];y[O][2]=p[O][2]||[],y[O][3]=p[O][3],!y.f&&((y.o||y)===p.o||(l=(i=y.tag)[Tr])!=null&&l.call(i,S,y.props))&&Yr(A,y[O][2])&&(y.s=!0)}p=y}else if(!Z(p)&&Te){const S=Ae(Te);S&&(p.n=S)}if(!Z(p)&&!p.s&&(Dt(e,p),delete p.f),d.push(p),m&&!m.s&&!p.s)for(let S=m;S&&!Z(S);S=(c=S.vC)==null?void 0:c.at(-1))S.nN=p;m=p}}t.vR=r?[...t.vC,...h||[]]:h||[],t.vC=d,r&&delete t.pC}catch(h){if(t.f=!0,h===rn){if(s)return;throw h}const[d,m,b]=((f=t[O])==null?void 0:f[3])||[];if(m){const p=()=>at([0,!1,e[2]],b),y=ot.get(b)||[];y.push(p),ot.set(b,y);const S=m(h,()=>{const A=ot.get(b);if(A){const C=A.indexOf(p);if(C!==-1)return A.splice(C,1),p()}});if(S){if(e[0]===1)e[1]=!0;else if(Dt(e,b,[S]),(m.length===1||e!==d)&&b.c){Fn(b,b.c,!1);return}throw rn}}throw h}finally{s&&e[5].pop()}},es=e=>{if(!(e==null||typeof e=="boolean")){if(typeof e=="string"||typeof e=="number")return{t:e.toString(),d:!0};if("vR"in e&&(e={tag:e.tag,props:e.props,key:e.key,f:e.f,type:e.tag,ref:e.props.ref,o:e.o||e}),typeof e.tag=="function")e[O]=[0,[]];else{const t=Vr[e.tag];t&&(Te||(Te=Tn("")),e.props.children=[{tag:Te,props:{value:e.n=`http://www.w3.org/${t}`,children:e.props.children}}])}return e}},sn=(e,t)=>{var n,r;(n=t[O][2])==null||n.forEach(([s,o])=>{s.values.push(o)});try{Dt(e,t,void 0)}catch{return}if(t.a){delete t.a;return}(r=t[O][2])==null||r.forEach(([s])=>{s.values.pop()}),(e[0]!==1||!e[1])&&Fn(t,t.c,!1)},Ne=new WeakMap,on=[],at=async(e,t)=>{e[5]||(e[5]=[]);const n=Ne.get(t);n&&n[0](void 0);let r;const s=new Promise(o=>r=o);if(Ne.set(t,[r,()=>{e[2]?e[2](e,t,o=>{sn(o,t)}).then(()=>r(t)):(sn(e,t),r(t))}]),on.length)on.at(-1).add(t);else{await Promise.resolve();const o=Ne.get(t);o&&(Ne.delete(t),o[1]())}return s},ts=(e,t,n)=>({tag:Ge,props:{children:e},key:n,e:t,p:1}),At=0,We=1,Ct=2,Et=3,xt=new WeakMap,Ut=(e,t)=>!e||!t||e.length!==t.length||t.some((n,r)=>n!==e[r]),ns=void 0,an=[],dt=e=>{var a;const t=()=>typeof e=="function"?e():e,n=_e.at(-1);if(!n)return[t(),()=>{}];const[,r]=n,s=(a=r[O][1])[At]||(a[At]=[]),o=r[O][0]++;return s[o]||(s[o]=[t(),i=>{const l=ns,c=s[o];if(typeof i=="function"&&(i=i(c[0])),!Object.is(i,c[0]))if(c[0]=i,an.length){const[f,h]=an.at(-1);Promise.all([f===3?r:at([f,!1,l],r),h]).then(([d])=>{if(!d||!(f===2||f===3))return;const m=d.vC;requestAnimationFrame(()=>{setTimeout(()=>{m===d.vC&&at([f===3?1:0,!1,l],d)})})})}else at([0,!1,l],r)}])},rs=(e,t,n)=>{var c;const r=_e.at(-1);if(!r)return;const[,s]=r,o=(c=s[O][1])[We]||(c[We]=[]),a=s[O][0]++,[i,,l]=o[a]||(o[a]=[]);if(Ut(i,n)){l&&l();const f=()=>{h[e]=void 0,h[2]=t()},h=[n,void 0,void 0,void 0,void 0];h[e]=f,o[a]=h}},ln=(e,t)=>rs(3,e,t),Kt=(e,t)=>{var i;const n=_e.at(-1);if(!n)return e;const[,r]=n,s=(i=r[O][1])[Ct]||(i[Ct]=[]),o=r[O][0]++,a=s[o];return Ut(a==null?void 0:a[1],t)?s[o]=[e,t]:e=s[o][0],e},ss=e=>{const t=xt.get(e);if(t){if(t.length===2)throw t[1];return t[0]}throw e.then(n=>xt.set(e,[n]),n=>xt.set(e,[void 0,n])),e},os=(e,t)=>{var i;const n=_e.at(-1);if(!n)return e();const[,r]=n,s=(i=r[O][1])[Et]||(i[Et]=[]),o=r[O][0]++,a=s[o];return Ut(a==null?void 0:a[1],t)&&(s[o]=[e(),t]),s[o][0]},as=Tn({pending:!1,data:null,method:null,action:null}),cn=new Set,is=e=>{cn.add(e),e.finally(()=>cn.delete(e))},qt=(e,t)=>os(()=>n=>{let r;e&&(typeof e=="function"?r=e(n)||(()=>{e(null)}):e&&"current"in e&&(e.current=n,r=()=>{e.current=null}));const s=t(n);return()=>{s==null||s(),r==null||r()}},[e]),Ce=Object.create(null),et=Object.create(null),Ye=(e,t,n,r,s)=>{if(t!=null&&t.itemProp)return{tag:e,props:t,type:e,ref:t.ref};const o=document.head;let{onLoad:a,onError:i,precedence:l,blocking:c,...f}=t,h=null,d=!1;const m=nt[e];let b;if(m.length>0){const A=o.querySelectorAll(e);e:for(const C of A)for(const x of nt[e])if(C.getAttribute(x)===t[x]){h=C;break e}if(!h){const C=m.reduce((x,R)=>t[R]===void 0?x:`${x}-${R}-${t[R]}`,e);d=!et[C],h=et[C]||(et[C]=(()=>{const x=document.createElement(e);for(const R of m)t[R]!==void 0&&x.setAttribute(R,t[R]),t.rel&&x.setAttribute("rel",t.rel);return x})())}}else b=o.querySelectorAll(e);l=r?l??"":void 0,r&&(f[rt]=l);const p=Kt(A=>{if(m.length>0){let C=!1;for(const x of o.querySelectorAll(e)){if(C&&x.getAttribute(rt)!==l){o.insertBefore(A,x);return}x.getAttribute(rt)===l&&(C=!0)}o.appendChild(A)}else if(b){let C=!1;for(const x of b)if(x===A){C=!0;break}C||o.insertBefore(A,o.contains(b[0])?b[0]:o.querySelector(e)),b=void 0}},[l]),y=qt(t.ref,A=>{var R;const C=m[0];if(n===2&&(A.innerHTML=""),(d||b)&&p(A),!i&&!a)return;let x=Ce[R=A.getAttribute(C)]||(Ce[R]=new Promise((q,V)=>{A.addEventListener("load",q),A.addEventListener("error",V)}));a&&(x=x.then(a)),i&&(x=x.catch(i)),x.catch(()=>{})});if(s&&c==="render"){const A=nt[e][0];if(t[A]){const C=t[A],x=Ce[C]||(Ce[C]=new Promise((R,q)=>{p(h),h.addEventListener("load",R),h.addEventListener("error",q)}));ss(x)}}const S={tag:e,type:e,props:{...f,ref:y},ref:y};return S.p=n,h&&(S.e=h),ts(S,o)},ls=e=>{const t=Jr(),n=t&&Ae(t);return n!=null&&n.endsWith("svg")?{tag:"title",props:e,type:"title",ref:e.ref}:Ye("title",e,void 0,!1,!1)},cs=e=>!e||["src","async"].some(t=>!e[t])?{tag:"script",props:e,type:"script",ref:e.ref}:Ye("script",e,1,!1,!0),us=e=>!e||!["href","precedence"].every(t=>t in e)?{tag:"style",props:e,type:"style",ref:e.ref}:(e["data-href"]=e.href,delete e.href,Ye("style",e,2,!0,!0)),fs=e=>!e||["onLoad","onError"].some(t=>t in e)||e.rel==="stylesheet"&&(!("precedence"in e)||"disabled"in e)?{tag:"link",props:e,type:"link",ref:e.ref}:Ye("link",e,1,"precedence"in e,!0),hs=e=>Ye("meta",e,void 0,!1,!1),Hn=Symbol(),ds=e=>{const{action:t,...n}=e;typeof t!="function"&&(n.action=t);const[r,s]=dt([null,!1]),o=Kt(async c=>{const f=c.isTrusted?t:c.detail[Hn];if(typeof f!="function")return;c.preventDefault();const h=new FormData(c.target);s([h,!0]);const d=f(h);d instanceof Promise&&(is(d),await d),s([null,!0])},[]),a=qt(e.ref,c=>(c.addEventListener("submit",o),()=>{c.removeEventListener("submit",o)})),[i,l]=r;return r[1]=!1,{tag:as,props:{value:{pending:i!==null,data:i,method:i?"post":null,action:i?t:null},children:{tag:"form",props:{...n,ref:a},type:"form",ref:a}},f:l}},Gn=(e,{formAction:t,...n})=>{if(typeof t=="function"){const r=Kt(s=>{s.preventDefault(),s.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Hn]:t}}))},[]);n.ref=qt(n.ref,s=>(s.addEventListener("click",r),()=>{s.removeEventListener("click",r)}))}return{tag:e,props:n,type:e,ref:n.ref}},ps=e=>Gn("input",e),ms=e=>Gn("button",e);Object.assign(_t,{title:ls,script:cs,style:us,link:fs,meta:hs,form:ds,input:ps,button:ms});new TextEncoder;var gs=Ht(null),vs=(e,t,n,r)=>(s,o)=>{const a="<!DOCTYPE html>",i=n?Tt(c=>n(c,e),{Layout:t,...o},s):s,l=_r`${B(a)}${Tt(gs.Provider,{value:e},i)}`;return e.html(l)},bs=(e,t)=>function(r,s){const o=r.getLayout()??gt;return e&&r.setLayout(a=>e({...a,Layout:o},r)),r.setRenderer(vs(r,o,e)),s()};const ys=bs(({children:e})=>v("html",{lang:"en",children:[v("head",{children:[v("meta",{charset:"utf-8"}),v("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),v("link",{rel:"icon",href:"/favicon.ico"}),v(ko,{href:"/app/style.css",rel:"stylesheet"}),v(xo,{src:"/app/client.ts",async:!0})]}),v("body",{children:e})]})),Ss=Object.freeze(Object.defineProperty({__proto__:null,default:ys},Symbol.toStringTag,{value:"Module"}));function ws(e){const t=e.split(`
